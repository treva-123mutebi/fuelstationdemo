	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Receipt Items</h3>
                  <p>(If empty, Refresh page after confirming approval to continue from supervisor)</p>
                </div>
                <div class="box-body">
                  <!-- Date range -->
...
<?php
		...
		$query=mysqli_query($con,"select * from reviewsales_details natural join reviewsales natural join product natural join category where branch_id='$branch' and reviewstatus='approved' or 'declined' ")or die(mysqli_error());
			$grand=0;
		while($row=mysqli_fetch_array($query)){
