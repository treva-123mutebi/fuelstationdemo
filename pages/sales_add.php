...
include('../dist/includes/dbcon.php');
	...
	$cid=$_REQUEST['cid'];
		...
		mysqli_query($con,"INSERT INTO sales(cust_id,user_id,amount_due,total,date_added,modeofpayment,branch_id) 
	...
	$query=mysqli_query($con,"select * from reviewsales_details natural join reviewsales where reviewstatus='approved'")or die(mysqli_error($con));
		while ($row=mysqli_fetch_array($query))
		{
			...
			mysqli_query($con,"INSERT INTO sales_details(prod_id,sales_qty,price,sales_id) VALUES('$pid','$qty','$price','$sales_id')")or die(mysqli_error($con));
