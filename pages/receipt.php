...
?>    
                  ...
                  <table class="table">
                    ...
                    <tbody>
<?php
		$query=mysqli_query($con,"select * from sales_details natural join product natural join category where sales_id='$sid'")or die(mysqli_error($con));
			$grand=0;
