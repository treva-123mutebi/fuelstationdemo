...
<html>
  <head>
    ...
    <title>Incoming Stock | <?php include('../dist/includes/title.php');?></title>
        ...
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Incoming Stock</li>
            </ol>
          </section>
...
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" value="<?php //echo $row['serial'];?>" required>  
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Batch Number</label>
        ...
        <div class="form-group">
					<label class="control-label col-lg-3" for="name">Expiry Date</label>
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['prod_id'];?>" required>  
					  <input type="text" class="form-control" id="name" name="expirydate" value="<?php echo $row['expirydate'];?>" required>  
					</div>
				</div> 
        <!--<div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="desc" value="<?php //echo $row['prod_desc'];?>" required>  
				...
				<div class="form-group">
							<label class="control-label col-lg-3" >Item Description</label>
							<div class="col-lg-9">
    ...
    <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
            <input type="text" class="form-control" id="name" name="prod_name" placeholder="Batch Number" required>  
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Expiry Date</label>
          <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
            <input type="text" class="form-control" id="name" name="expirydate" placeholder="year/month/date" required>  
          </div>
        </div> 
        <!--<div class="form-group">
          <label class="control-label col-lg-3" for="price">Product Name</label>
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="prod_desc" placeholder="Product Name"></textarea>  
          </div>
        </div>-->
        <div class="form-group">
          <label class="control-label col-lg-3" for="file">Supplier</label>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Unit Price</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="prod_price" placeholder="Unit Price" required>  
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Quantity</label>
          <div class="col-lg-9">
            <input type="number" class="form-control" id="price" name="prod_qty" placeholder="Quantity"  required>  
          </div>
        </div>
        <div class="form-group">
