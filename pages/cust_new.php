...
<html>
  <head>
    ...
    <title>Register Sales | <?php include('../dist/includes/title.php');?></title>
        ...
        <div class="container">
          ...
          <section class="content">
            ...
            <div class="col-md-4">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Search Station Pump</h3>
                </div>
                <div class="box-body">
                ...
                <form method="post" action="cash_transaction.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      ...
                      ?>
            <option value="<?php echo $row2['pumpid'];?>"><?php echo $row2['pumpnumber'];?></option>
          <?php }?>
                    </select>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
