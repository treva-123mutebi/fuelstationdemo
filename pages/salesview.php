      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="stationsales.php">Record New Sales</a>
...
?>
                  <table class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Open Meter Reading</th>
                        <th>Close Meter Reading</th>
                        <th>Unit Price</th>
                        <th>Quantity Sold (ltrs)</th>
						            <th>Total (UGX)</th>
                        <!--<th>Action</th>-->
                      </tr>
                    </thead>
    ...
    $query=mysqli_query($con,"select * from salesdemoview natural join pumps natural join shifts natural join stationproducts where branch_id='$branch' order by date")or die(mysqli_error());
    $grand=0;
		while($row=mysqli_fetch_array($query)){
      $total=$row['quantitysold']*$row['unitprice'];
      $grand=$grand+$total;
...
?>
                      <tr >
						...
						<td><?php echo $row['pumpnumber'];?></td>
                        <td class="record" style="font-size:12px;"><?php echo $row['shift_details'];?></td>
                        <td class="record" style="font-size:12px;"><?php echo $row['stationprod_name'];?></td>
                        
                        <td class="record"><?php echo $row['openmeterreading'];?></td>
                        <td class="record"><?php echo $row['closemeterreading'];?></td>
            <td><?php echo number_format($row['unitprice'],2);?></td>
            <td class="record"><?php echo $row['quantitysold'];?></td>
