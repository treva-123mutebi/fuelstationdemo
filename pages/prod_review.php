	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <p>(If empty, refresh page(F5) after approval from Supervisor)</p><br/>
                  <a href="#" class="btn btn-danger">Dont Print if it has been declined</a>
                </div>
                <div class="box-body">
                  <!-- Date range -->
...
?>
    ...
    $query=mysqli_query($con,"select * from reviewproduct natural join reviewstockin natural join category where branch_id='$branch' and reviewstatus='approved' or 'declined'")or die(mysqli_error());
    $grand=0;
...
<?php }?>					  
            ...
            <div class="col-md-3">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
          <form method="post" name="autoSumForm" action="stock_add.php">
				  <div class="row">
					 <div class="col-md-12">
