                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select prod_name,cat_name from product natural join category where prod_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
			  while($rowprod=mysqli_fetch_array($queryprod)){
			?>
                          <li><!-- start notification -->
                            <a href="product.php">
                              <i class="glyphicon glyphicon-refresh text-red"></i> <?php echo $rowprod['cat_name'];?>.<?php echo $rowprod['prod_name'];?>
                            </a>
                          </li><!-- end notification -->
                          <?php }?>
                        </ul>
